  ...
  return (
    <ul className="nav nav-pills flex-column mb-auto">
      <li className="nav-item">
        <a
          href="/admin/users"
          className={clsx("nav-link", pathName === "/admin/users" && "active")}
          aria-current="page"
        >
          <svg
      ...
      <li className="nav-item">
        <a
          href={
            permanentEstablishmentId
              ? `/admin/${companyId}/${permanentEstablishmentId}/settings`
              : `/admin/${companyId}/settings`
          }
          className={clsx(
            "nav-link",
        ...
        >
          <svg
            ...
            height="16"
            fill="currentColor"
            className="bi bi-gear pe-none me-2"
            viewBox="0 0 16 16"
          >
